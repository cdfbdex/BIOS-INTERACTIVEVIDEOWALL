...
**
** Created: Thu 16. Apr 16:20:04 2015
...
public:
    ...
    QComboBox *comboBox_SelectionType;
    QLabel *label_6;
    ...
    void setupUi(QMainWindow *IVW_mainWindow)
    {
        ...
        comboBox_SelectionType = new QComboBox(centralWidget);
        comboBox_SelectionType->setObjectName(QString::fromUtf8("comboBox_SelectionType"));

        gridLayout_2->addWidget(comboBox_SelectionType, 0, 2, 1, 2);
    ...
    void retranslateUi(QMainWindow *IVW_mainWindow)
    {
        ...
        comboBox_SelectionType->clear();
        comboBox_SelectionType->insertItems(0, QStringList()
         << QApplication::translate("IVW_mainWindow", "Frames", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("IVW_mainWindow", "Time", 0, QApplication::UnicodeUTF8)
        );
        label_6->setText(QApplication::translate("IVW_mainWindow", "Selection mode:", 0, QApplication::UnicodeUTF8));
