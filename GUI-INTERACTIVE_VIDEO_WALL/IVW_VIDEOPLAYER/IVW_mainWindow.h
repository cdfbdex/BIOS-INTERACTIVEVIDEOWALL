...
private slots:
	...
	void comboBox_SelectionType_Changed(int index);
	void toolButton_SendToInteractiveWall_Clicked();

	void On_ProcesoTerminado(int, QProcess::ExitStatus);
...
private:
	...
	int current_comboBox_index;				// 0 if the range is in frames, 1 if the range is in miliseconds
